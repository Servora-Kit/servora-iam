...
- [ ] **T1: 盘点需按 org/project 过滤的 repo 方法**
...
- [ ] **T3: 可选 — data 层 scope predicate 辅助**
  - 若需要，在 `internal/data/scope.go` 提供 OrgScope(orgID)、ProjectScope(projectID) 等返回 predicate，供多处复用

## 第二阶段：OpenFGA 创建/成员变更回滚

- [ ] **T4: Organization Create 顺序与回滚**
